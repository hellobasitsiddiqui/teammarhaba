-- V58__events_series_reference — link events to their recurring series (TM-789 / recurring events v1)
--
-- The events → event_series reference (V57 created the series table). Three columns, all additive and
