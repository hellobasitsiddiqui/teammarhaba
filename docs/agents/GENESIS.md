...
- **Branch naming:** `<type>/TM-XX-short-kebab-desc` — the prefix must match the *nature* of the work: **`feature/`** = app feature (Story/Task), **`fix/`** = a Bug, **`chore/`** = infra/CI/cloud/docs/config.
