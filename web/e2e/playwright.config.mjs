...
export default defineConfig({
  ...
  projects: [
    ...
    // spec (TM-587, captured at the Pixel 5 surface TM-564 uses).
    {
      ...
      testIgnore: /(responsive-mobile|chat-foundation|tm710-announcement)\.spec\.mjs/,
    },
    ...
    // hamburger nav at a phone width) so those flows are proven on mobile web as well as desktop.
    {
      ...
      use: { ...devices["Pixel 5"] },
      testMatch: /(responsive-mobile|golden-path|broadcast-admin|events|chat-foundation|tm710-announcement)\.spec\.mjs/,
    },
  ],
