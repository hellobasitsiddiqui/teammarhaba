...
test("@profile @tm930 gate happy path: verify + link the phone, land in the app, GET /me phone = the verified E.164", async ({
  page,
}) => {
...
test("@profile @tm930 collision: a number linked to another account HARD-BLOCKS with the exact copy, gate does not lift", async ({
  browser,
}) => {
