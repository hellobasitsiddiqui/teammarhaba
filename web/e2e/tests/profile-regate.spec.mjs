...
import { AUTH_EMULATOR_HOST, API_BASE_URL, seededPhoneFor } from "../fixtures.mjs";
...
async function createCompletedAccount() {
  ...
  // TM-931: the seeded phone must be UNIQUE (V48 index 409s a duplicate), so derive one from this
  // account's per-run email rather than a shared literal.
