...
//   • The handful of classic <script> files (config.js, appearance.js, app.js —
//     build-info.js became a module in TM-666; nav-toggle.js was deleted in TM-1043) contain no
//     module-incompatible syntax and parse
